...
Proj-2.0-Docker-K8s-Helm % minikube tunnel

Proj-2.0-Docker-K8s-Helm % sudo nano /etc/hosts

Add `127.0.0.1   api.jayaraj.dev`

Proj-2.0-Docker-K8s-Helm % curl https://api.jayaraj.dev

{"message":"Welcome to the Event Notification Service API","docs":"/docs"}%

Go to: `https://api.jayaraj.dev/metrics` to see fast-api metrics
